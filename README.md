...
**[Презентация проекта](https://disk.yandex.ru/d/CmQeVeQ9jz5AOg)**

Руководство по использованию системы планирования исследований биоэквивалентности (BE).

## Навигация

- [1. Формат и структура входных данных](#1-формат-и-структура-входных-данных)
- [2. Архитектура решения](#2-архитектура-решения)
- [3. Инструкция по загрузке и вводу данных](#3-инструкция-по-загрузке-и-вводу-данных)
- [4. Формат выдачи результата и интерпретация рекомендаций](#4-формат-выдачи-результата-и-интерпретация-рекомендаций)
- [5. Ограничения, допущения и область применимости](#5-ограничения-допущения-и-область-применимости)
- [6. Методология валидации и метрики качества](#6-методология-валидации-и-метрики-качества)
- [7. Сценарии тестирования](#7-сценарии-тестирования)
